...
<div class="mx-auto flex max-w-lg flex-col gap-6 px-4 py-16">
	<h1 class="text-3xl font-semibold text-base-content">Privacy policy</h1>
	<p class="leading-relaxed text-base-content/80">
		We are setting up our privacy policy. Soon you will find here how we collect, use, and protect
