...
async def unhandled_exception_handler(request: Request, exc: Exception) -> JSONResponse:
    ...
    we **must not** leak internal exception detail to the client. We attach an opaque
    ``trace_id`` to the response and the structured log so the operator can correlate.
    """
